...
const SingleRegistrationForm = ({ onCancel, onSubmit }) => {
    ...
    return (
        <div className="card">
            ...
            <div className="form-row">
                <div className="form-group">
                    <label>Sample ID <span className="required">*</span></label>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '12px', marginTop: '32px', paddingTop: '20px', borderTop: '1px solid #eee' }}>
                <button className="btn" style={{ border: '1px solid #ccc', background: 'white' }} onClick={onCancel}>Cancel</button>
                <button className="btn" style={{ background: '#F57C00', color: 'white' }}>Save as Draft</button>
