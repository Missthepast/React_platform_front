...
const BulkRegistrationForm: React.FC<BulkRegistrationFormProps> = ({ onCancel }) => {
  return (
    <div className="card">
      <div
        style={{
      ...
      >
        ...
        <p style={{ fontSize: '13px', marginTop: '8px', color: '#333', lineHeight: '1.5' }}>
          Please download the template below, fill in the sample information, and upload the
          completed file.
          <br />
        ...
        <button
          ...
          style={{ marginTop: '12px', background: '#1976D2', padding: '8px 16px' }}
        >
      ...
      >
        ...
        <p style={{ fontSize: '12px', color: '#999', marginTop: '8px' }}>
          XLSX/XLS/CSV files with a size less than 10MB
        </p>
      </div>
    </div>
  );
