            ...
            <div className="card" style={{ marginBottom: '24px' }}>
                ...
                <div className="card-body">
                    <div className="flex gap-md" style={{ flexWrap: 'wrap' }}>
                        <div style={{ padding: '16px', background: '#00897B', color: 'white', borderRadius: '8px' }}>
                            Primary: #00897B
                        </div>
                        <div style={{ padding: '16px', background: '#2E7D32', color: 'white', borderRadius: '8px' }}>
                            Success: #2E7D32
                        </div>
                        <div style={{ padding: '16px', background: '#F57C00', color: 'white', borderRadius: '8px' }}>
                            Warning: #F57C00
                        </div>
                        <div style={{ padding: '16px', background: '#D32F2F', color: 'white', borderRadius: '8px' }}>
                            Error: #D32F2F
                        </div>
                    </div>
                </div>
